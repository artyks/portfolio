...
export namespace Prisma {
  ...
  */
  ...
  export type AssetGetPayload<S extends boolean | null | undefined | AssetArgs> = S extends {
    select: any;
    include: any;
  }
    ? 'Please either choose `select` or `include`'
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends keyof Asset ? Asset[P] : never;
      }
    : Asset;
  ...
  > {
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Asset'> extends True
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Asset'> extends True
      ? Prisma__AssetClient<AssetGetPayload<T>>
      : Prisma__AssetClient<AssetGetPayload<T> | null, null>;
     ...
     *
     **/
    create<T extends AssetCreateArgs>(args: SelectSubset<T, AssetCreateArgs>): Prisma__AssetClient<AssetGetPayload<T>>;
     ...
     *
     **/
    delete<T extends AssetDeleteArgs>(args: SelectSubset<T, AssetDeleteArgs>): Prisma__AssetClient<AssetGetPayload<T>>;
     ...
     *
     **/
    update<T extends AssetUpdateArgs>(args: SelectSubset<T, AssetUpdateArgs>): Prisma__AssetClient<AssetGetPayload<T>>;
     ...
     * })
     **/
    upsert<T extends AssetUpsertArgs>(args: SelectSubset<T, AssetUpsertArgs>): Prisma__AssetClient<AssetGetPayload<T>>;
  ...
  export type AssetWhereInput = {
    ...
    imageWidth?: IntNullableFilter | number | null;
    imageHeight?: IntNullableFilter | number | null;
  ...
  export type AssetScalarWhereWithAggregatesInput = {
    ...
    imageWidth?: IntNullableWithAggregatesFilter | number | null;
    imageHeight?: IntNullableWithAggregatesFilter | number | null;
